...
public class AdminController {
    ...
    public ResponseEntity<UserResponseDto> updatePhoneNumber(@PathVariable Long userId, @RequestBody UserRegisterDto user) {
        UserResponseDto updated = service.updateUserPhoneNumber(userId, user.phoneNumber());
        return ResponseEntity.ok(updated);
    }
